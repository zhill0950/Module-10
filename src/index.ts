...
class EmployeeDatabaseManager {
    ...
    addDept(): void {
        inquirer
            ...
            .then(async (answers: { name: string }) => {
                try {
                    await pool.query(
    ...
    addRole(): void {
        inquirer
            ...
            .then(async (answers: { title: string, salary: number, department_id: number }) => {
                try {
                    await pool.query(
    ...
    addEmployee(): void {
        inquirer
            ...
            .then(async (answers: { first_name: string, last_name: string, role_id: number, manager_id: number | null }) => {
                try {
                    await pool.query(
    ...
    updateEmployeeRole(): void {
        inquirer
            ...
            .then(async (answers: { employee_id: number, new_role_id: number }) => {
                try {
                    await pool.query(
